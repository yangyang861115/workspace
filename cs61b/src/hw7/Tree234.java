...
public class Tree234 extends IntDictionary {
	...
	public void insert(int key) {
		...
		if (isEmpty()) {
			...
			if(node == root && node.keys == 3){
				...
				if(node.child1 != null) node.child1.parent = c1;
				c1.child2 = node.child2;
				if(node.child2 != null) node.child2.parent = c1;
				Tree234Node c3 = new Tree234Node(root, node.key3);
				c3.child1 = node.child3;
				c3.child2 = node.child4;
				if(node.child3 != null) node.child3.parent = c3;
				if(node.child4 != null) node.child4.parent = c3;
				//parent is null, node is the root
			...
			while (node != null) {
				...
				if (node.keys == 3 ) {
					...
					Tree234Node c1 = new Tree234Node(node.parent, node.key1);
					c1.child1 = node.child1;
					if(node.child1 != null) node.child1.parent = c1;
					c1.child2 = node.child2;
					if(node.child2 != null) node.child2.parent = c1;
					Tree234Node c3 = new Tree234Node(node.parent, node.key3);
					c3.child1 = node.child3;
					if(node.child3 != null) node.child3.parent = c3;
					c3.child2 = node.child4;
					if(node.child4 != null) node.child4.parent = c3;
	...
	public static void main(String[] args) {
		...
		t.insert(7);
		t.testHelper("7 84");
		System.out.println(t.root.key1);
