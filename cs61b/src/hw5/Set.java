...
public class Set {
  ...
  public void union(Set s) {
    // Your solution here.
	  ...
	  ListNode node = s.lst.front();
	  try {
		  while(node.isValidNode()){
			  insert((Comparable) node.item());
			  node = node.next();
		  }
	  } catch (InvalidNodeException e) {
			// TODO Auto-generated catch block
  ...
  public void intersect(Set s) {
    // Your solution here.
	  ...
	  if(this.lst.length() == 0 || s.lst.length() == 0){
		  this.lst = new DList();
		  return;
	  }
	  
	  ListNode n2 = s.lst.front();
	  ListNode n1 = this.lst.front();
  ...
  public static void main(String[] argv) {
    ...
    // You may want to add more (ungraded) test code here.z
