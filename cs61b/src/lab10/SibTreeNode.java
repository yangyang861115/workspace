  ...
  public void insertChild(Object item, int c) throws InvalidNodeException {
    // FILL IN YOUR SOLUTION TO PART II HERE.
	  if (!isValidNode()){
			...
			SibTreeNode newkid = new SibTreeNode(myTree, item);
		    if(firstChild == null){
		    	firstChild = newkid;
		    	newkid.parent = this;
		    	...
		    	if(c > children()){
		    		...
		    		kid.nextSibling = newkid;
		    		newkid.parent = kid.parent;
		    	}else if(c == 1){
		    		//insert front
		    		firstChild = newkid;
		    		newkid.nextSibling = kid;
		    		newkid.parent = kid.parent;
		    	}
		    	else{
		    		//insert middle
		    		...
		    		newkid.nextSibling = kid.nextSibling;
		    		kid.nextSibling = newkid;
		    		newkid.parent = kid.parent;
		    	}
	  ...
	  if (!isValidNode()){
		  ...
		  if(firstChild == null){
			  ...
			  if(nextSibling == null){
				  ...
				  else if(parentNode.children() == 1){
					  parentNode.firstChild = null;
				  }else{
					  int c = parentNode.children();
					  SibTreeNode kid = parentNode.firstChild;
					  while(c > 2){
						  kid = kid.nextSibling;
					  }
				  ...
				  SibTreeNode sibNode = nextSibling;
				  parentNode.firstChild = sibNode;
				  parent = null;
				  valid = false;
				  nextSibling = null;
			  }
