...
public class retrieveCollections1 {

	private MongoClient mongoClient;
	private DB db;
	private DBCollection traingingCollections;
	private DBCollection testCollections;
	retrieveCollections1 (MongoClient mongoClient,DB db,DBCollection trainingCollection,DBCollection testCollection){
	...
	public static void main(String args[]) throws UnknownHostException{
		...
		retrieveCollections1 collect=new retrieveCollections1(mongoClient,db,trainingCollection,testCollection);
